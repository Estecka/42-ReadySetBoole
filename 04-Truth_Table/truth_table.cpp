...
/*   Updated: 2022/10/26 19:15:04 by abaur            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	Header(std::ostream& cout, const std::string& expr, short& varcount, char shiftmap[26]){
...
static void	Row(std::ostream& cout, short i, short varcount, const char* shiftmap, const std::string& expr){
	...
	cout << "| " << eval_formula(expr, varmap) << " |" << std::endl;
}
...
extern void	print_truth_table(const std::string& expr) {
	...
	for (int i=0; i<(1<<varcount); i++)
		Row(std::cout, i, varcount, shiftmap, expr);
}
